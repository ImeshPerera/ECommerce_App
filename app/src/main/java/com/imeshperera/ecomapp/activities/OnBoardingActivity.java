...
import com.imeshperera.ecomapp.adapters.SliderAdapter;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    private void addDots(int position){
        ...
        if(dots.length > 0) dots[position].setTextColor(getResources().getColor(R.color.pink));
    }
